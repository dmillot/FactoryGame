...
{
    public enum RequestType { CONNEXION_RESPONSE, CHOOSE_DEVELOPER, CHOOSE_TRAINING_SESSION, CHOOSE_PROJECT, ASSOCIATE_DEV_PROJECT, ANALYSE_MARKET, FINISH_TURN, FIRE_DEVELOPER, GAME_START, PLAYER_TURN, ADMIN_START_GAME, INITIALIZE_GAME, END_GAME };
